const proyectos = [
  ...
  },
  {
    ...
    estado: "Finalizado",
    descripcion: [
      "Aplicación móvil que permite a los pacientes reservar, cancelar y consultar turnos médicos desde su celular.",
      "Incluye notificaciones automáticas de recordatorio y un panel para que los médicos administren su agenda diaria."
    ],
    recursos: [
  ...
  },
  {
    ...
    estado: "En curso",
    descripcion: [
      "Plataforma de comercio electrónico orientada a la venta de indumentaria, con catálogo de productos y pasarela de pagos integrada.",
      "El proyecto contempla también un panel de administración para gestionar stock y estadísticas de ventas en tiempo real."
    ],
    recursos: [
